...
$get_recent = $baglan->query("SELECT * FROM yazi WHERE dil=''");
...
if($get_recent->num_rows) {
    ...
    while($row = $get_recent->fetch_assoc()) {
          ...
          <div class='col-md-7 order-md-2'>
            ...
            <p class='lead mb-0'> <a href='detay.php?blogid=".$row['id']."' class='text-success font-weight-bold'>DEVAMINI OKU</a></p>
          </div>
...
<head>
    <title>XYZ Media - Anasayfa</title>
    <meta charset="UTF-8">
        ...
        <div class="container" style="background:silver;">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12">
                    ...
                    <?php echo ($yazilar == "") ? "<h3 style=' text-align: center; font-weight: lighter; padding: 10px 0px; background: #ffeeee; color: #333;'>Yetki Yok!</h3>" : $yazilar; ?>
                    <p class="clear"></p>
